...
public final class ObjectDefinition {
	...
	public ObjectDefinition method580() {
		...
		if (varbit != -1) {
			...
			@SuppressWarnings("unused")
			int i1 = StaticLogic.BIT_MASKS[l - k];
		}
		/*
		 * i = clientInstance.settings[j] >> k & i1; } else if (varp != -1) i =
		 * clientInstance.settings[varp];
		 */
	...
	public Model model(int j, int k, int l) {
		...
		/*
		 * if (modifiedTexture != null) { for (int k2 = 0; k2 <
		 * modifiedTexture.length; k2++) model_3.retexture(modifiedTexture[k2],
		 * originalTexture[k2], -1); }
		 */
		if (flag)
