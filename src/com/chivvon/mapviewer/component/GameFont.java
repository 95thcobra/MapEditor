...
public final class GameFont extends Rasterizer2D {
	...
	public GameFont(boolean flag, String s, Archive archive) throws IOException {		
	...
	public void drawText(int hexColor, String string, int x, int y) {		
		render(hexColor, string, y, x - method384(string) / 2);
	}

	public void method382(int hexColor, String string, int x, int y, boolean shadow) {		
		drawTextWithPotentialShadow(shadow, x - getTextWidth(string) / 2, hexColor, string, y);
	}
